...
const htmlContent = `<p>Until now, trying to style an article, document, or blog post with Tailwind has been a tedious task that required a keen eye for typography and a lot of complex custom CSS.</p>
...
const OnWhite: ComponentStory<typeof Prose> = () => (
  <Theme bg theme="white">
    <Prose dangerouslySetInnerHTML={{ __html: htmlContent }} />
  </Theme>
)
export const WhiteTheme = OnWhite.bind({})

const OnNavy: ComponentStory<typeof Prose> = () => (
  <Theme bg theme="navy">
    <Prose dangerouslySetInnerHTML={{ __html: htmlContent }} />
  </Theme>
)
export const NavyTheme = OnNavy.bind({})

const OnBlue: ComponentStory<typeof Prose> = () => (
  <Theme bg theme="blue">
    <Prose dangerouslySetInnerHTML={{ __html: htmlContent }} />
  </Theme>
)
export const BlueTheme = OnBlue.bind({})

const OnYellow: ComponentStory<typeof Prose> = () => (
  <Theme bg theme="yellow">
    <Prose dangerouslySetInnerHTML={{ __html: htmlContent }} />
  </Theme>
)
export const YellowTheme = OnYellow.bind({})
